...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('hLgGU1Y4hX', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('R8GI++pZ8w', 0, '8-GyLy7om4-SKyxNIw47T7', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f1ddc4501bb4f34579e8f65d65fda0854c81d35cab9ddee4b95ba5a4c5196817');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('L-9nglHfFR', NULL, '8-GyLy7om4-SKyxNIw47T7', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    /**
     * Gets the 'swapi' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\SwapiService A AppBundle\Services\SwapiService instance
     */
    protected function getSwapiService()
    {
        return $this->services['swapi'] = new \AppBundle\Services\SwapiService('http://swapi.co/api/');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('912c879e73c1adc91dcd63cd91ab2c51725dfeb6');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DAORKWaf9j', 0, '8-GyLy7om4-SKyxNIw47T7', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('588d092ecf4622.26757946')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '912c879e73c1adc91dcd63cd91ab2c51725dfeb6',
            'swapi_uri' => 'http://swapi.co/api/',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '912c879e73c1adc91dcd63cd91ab2c51725dfeb6',
